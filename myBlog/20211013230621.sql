...
MySQL Backup
Database: my_blog
Backup Time: 2021-10-13 23:06:21
*/
...
INSERT INTO `my_blog`.`blog_category` (`nid`,`title`,`blog`) VALUES (1, 'SpringBoot', 1),(2, '数据库', 1),(3, '数据库x', 2);
UNLOCK TABLES;
COMMIT;
BEGIN;
